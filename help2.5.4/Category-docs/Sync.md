...
در صورتی که در آژانس‌های مسافرتی از نرم‌افزارهایی مثل فرانگر و ژنیک استفاده می‌کنید؛ می‌توانید قراردادهای ایجاد شده را توسط ماژول همگام‌ساز به پیام‌گستر انتقال دهید.
