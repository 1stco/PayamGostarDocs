...
> **نکته:** در صورتی که **ایجادکننده فاکتور خرید یا مسوول فاکتور خرید** باشید یا یکی از مجوزهای  **ادمین** یا **مشاهده لیست فاکتور خرید** را داشته باشید، می‌توانید تب خرید را چه در پروفایل مشتری یا چه در منوی صفحه مشاهده کنید.
