...
> **نکته:** در لیست الگوهای تعریف شده، تنها امکان حذف و ویرایش الگوهایی وجود دارد که تا به حال در آیتمی‌ برای شماره‌گذاری استفاده نشده است.
...
با کلیک بر روی دکمه افزودن صفحه زیر برای تعریف الگوی شماره جدید نمایش داده می‌شود.
