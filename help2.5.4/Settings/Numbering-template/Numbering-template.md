...
یکی دیگر از وظایف راهبر، تنظیم الگوی شماره آیتم‌هاست. آیتم‌های هویت، انواع فاکتورها، پیش‌فاکتورها، قراردادها، دریافت و پرداخت‌ها نیاز به الگوی شماره دارند که باید از قبل این الگو تنظیم شده باشد تا در بخش تنظیمات شخصی‌سازی هر آیتم استفاده شود. 
...
![تنظیمات الگوی شماره‌گذاری]()

همچنین می‌توانید در قسمت شخصی‌سازی آیتم با کلیک روی ویرایش نوع و  کلیک بر روی دکمه + الگوی جدید تعریف کرد و از الگوهای تعریف شده، الگویی را برای شماره دهی این موجودیت انتخاب نمایید.
