...
در این صفحه امکان ایجاد و ویرایش اطلاعات کاربران وجود دارد. این قسمت جزو امنیتی ترین قسمت های نرم افزار محسوب می شود. لذا دسترسی به آن بر اساس نیاز های سازمان باید به تعداد 
افراد محدود و مشخصی داده شود. مراحل ساخت کاربر و گروه‌های کاربری به شرح زیر می باشد:
1.   می‌توانید لیست کاربران خود را از طریق اکسل از قسمت ورود اطلاعات کاربران به صورت اکسل وارد نمایید. و یا به صورت تکی از قسمت کاربر جدید () اطلاعات کاربر را وارد نمایید.
2.   از قسمت گروه‌ها لیست گروه‌های کاربری را ساخته و افراد را به گروه مربوطه متصل نمایید ().
