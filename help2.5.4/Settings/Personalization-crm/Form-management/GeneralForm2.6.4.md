...
- **ذخیره فرم بدون پروفایل مرتبط**<br>
   ...
   ![صفحه فرم عمومی بدون اطلاعات تماسی هویت](General-Form-Without-Identity.png)
...
![لیست فرم عمومی بدون هویت مرتبط](ListOfFormWithoutIdentity.png)
...
- **ذخیره فرم با پروفایل مرتبط**<br>
   ...
   ![تنظیمات هویت مرتبط در شخصی‌سازی فرم عمومی](Identity-in-general-form.png)
...
![انتخاب نوع سرنخ حقیقی یا حقوقی در فرم عمومی](TypeOfIdentityInGeneralForm.png)

اگر نوع سرنخ را حقوقی انتخاب کنید صفحه‌ای که مخاطب شما در سایت مشاهده می‌کند به شکل زیر خواهد بود.

![اطلاعات سرنخ حقوقی در فرم عمومی](Organization-Identity-In-General-Form.png)

و در صورت انتخاب نوع سرنخ حقیقی، اطلاعات تماسی هویت در فرم عمومی همراه با نام و نام خانوادگی خواهد بود.

![اطلاعات سرنخ حقیقی در فرم عمومی](Person-In-General-Form.png)
...
- **تنظیمات جستجوی پروفایل مرتبط**<br>
   ...
   ![جستجوی هویت مرتبط در فرم عمومی](Search-Identity-In-General-Form.png)
