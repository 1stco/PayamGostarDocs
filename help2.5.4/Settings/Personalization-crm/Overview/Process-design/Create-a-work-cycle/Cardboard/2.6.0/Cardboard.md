...
در این روش شما می‌توانید با فعال کردن  فیلد آخرین مسئول،یک  فیلد  را در نظر بگیرید که در طی فرآیند مقداردهی شود در اینصورت می‌توانید مشخص کنید که کار به شخص انخاب شده در فیلد، مدیر فیلد و رده بالایی فیلد تخصیص یابد.

در صورت صرف نظر از استفاده از فیلد کیتوایند کارتابلی را برای انتخاب آخرین مسؤل کارتابل  مشخص کنید که کار به آخرین مسؤل یا مدیر آخرین مسؤل یا رده بالایی آخرین مسؤل تخصیص یابد.
