...
![صفحه از تنظیمات کارتابل در فرآیند](1.png)
...
**انتخاب رده بالایی فیلد/ آخرین مسئول**<br>
 ...
 اگر مالک آیتم هم تعیین نشده بود، فرآیند به کارتابل کاربر تعیین شده در [**تنظیمات کلی** > **فرآیند**](https://github.com/1stco/PayamGostarDocs/blob/master/help2.5.4/Settings/General-settings/Process/Process.md) ارجاع می‌دهد.
