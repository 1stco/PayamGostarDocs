...
> نکته 2: توجه داشته باشید موجودی نمایش داده شده برای محصولات بر اساس تراکنش های تایید شده می باشد و همچنین[ گزارشات انبار ](https://github.com/1stco/PayamGostarDocs/blob/master/help2.5.4/Buy-warehouse-sales/Store/Store.md)نیز، تنها تراکنش های تایید شده را لحاظ خواهد کرد. 
