...
برای مطالعه‌ی راهنمای ورود اطلاعات از طریق اکسل به [ثبت دریافت‌ها/پرداخت‌ها از طریق اکسل](https://github.com/1stco/PayamGostarDocs/blob/master/releasenote/2.6.0/Contracts.md) مراجعه کنید.
