...
مراحلی از گردش کار که توسط نیروی انسانی (کاربران سیستم) انجام می شوند، کارتابل نامیده می شود. آیتم تحت فرآیند به محض رسیدن به یک کارتابل، در [کارتابل فرآیند](https://github.com/1stco/PayamGostarDocs/blob/master/help%202.5.4/home/widget/Cardboard/widget-processes/widget-processes.md)های مسئول مشخص شده برای آن مشاهده خواهد شد و او با استفاده از اقدام های تعیین شده در آن مرحله می تواند فرآیند را به مراحل بعدی هدایت کند.
...
1. کاربر/گروه/سمت مشخص: کاربر/گروه/سمت مرتبط را با انتخاب از لیست انتخاب می نمایید. ( برای ساخت کاربران و گروه های کاربری به مدیریت گروه ها و کاربران و برای ساخت سمت های حدی به قسمت[ مدیریت شعب - دپارتمان و سمت ](https://github.com/1stco/PayamGostarDocs/blob/master/help%202.5.4/Basic-Information/branches-department/branches-department.md)مراجعه کنید.)
