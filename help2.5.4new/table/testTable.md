<img src="https://github.com/RickStrahl/MarkdownMonster/raw/main/Art/MarkdownMonster_Icon_128.png" align="right" style="height: 64px"/>
...
### Pipe Tables
[Pipe Tables](https://github.com/lunet-io/markdig/blob/main/src/Markdig.Tests/Specs/PipeTableSpecs.md) can be used to create simple single line tables:
...
### Grid Tables
[Grid Tables](https://github.com/lunet-io/markdig/blob/main/src/Markdig.Tests/Specs/GridTableSpecs.md) are a bit more flexible than Pipe Tables in that they can have multiple lines of text per cell and handle multi-line embedded Markdown text.
