...
![](Callsnotificationsettings/Callsnotificationsettings.png) 
...
3\. **اضافه کردن رویداد تماس:** با استفاده از این کلید می توانید یک [رویداد تماس جدید](Callsnotificationsettings/AddCallsnotificationsettings.md) اضافه نمایید.