...
شما می‌توانید در صورت فراموشی رمز عبور حساب خود، آن را از طریق وب‌سایت بازیابی کنید.
> **توجه** <br>
  به دلایل امنیتی، برداشت از حساب به مدت 24 ساعت پس از بازیابی رمز عبور معلق خواهد شد.<br>
