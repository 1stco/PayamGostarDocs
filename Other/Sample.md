...
اگر سرور بتواند درخواست کلاینت را انجام دهد، API منبع موردنیاز کلاینت یا یک کد وضعیت را بازمی‌گرداند و مأموریت با موفقیت انجام می‌شود، API در غیر این صورت یک پیغام خطا ارسال می‌کند.