...
###  ثبت پیش‌فاکتور از طریق تب فروش
...
برای ثبت پیش‌فاکتور از طریق صفحه اصلی مخاطب می‌توانید از طریق مسیر‌های زیر اقدام نمایید:
...
![مسیر اول ثبت پیش‌فاکتور از صفحه مخاطب](./Images/)

- **صفحه اصلی پروفایل مخاطب** > **تب فروش** > **پیش‌فاکتور**

![مسیر دوم ثبت پیش‌فاکتور از صفحه مخاطب](./Images/)

- **صفحه اصلی پروفایل مخاطب** > **تب سوابق** > **صدور پیش‌فاکتور جدید**

![مسیر سوم ثبت پیش‌فاکتور از صفحه مخاطب](./Images/)
...
> **راهنمای مدیر سیستم**<br>
> در صورت نیاز به اعمال عوارض و مالیات روی هر یک از زیرنوع‌های پیش‌فاکتور می‌تواند از طریق شخصی‌سازی CRM اقدام کنید و به صورت دقیق مشخص کنید روی هر یک از زیرنوع‌های پیش‌فاکتور چقدر عوارض و مالیات اعمال شود.
...
> **نکته**<br> 
> اگر طی شخصی‌سازی پیش‌فاکتور در سازمان شما،‌ مبلغ اضافات به پیش‌فاکتور فروش شما اضافه شده‌باشد،‌ فیلد مجموع این مبلغ را نیز در این بخش مشاهده می‌کنید. به عنوان مثال به مبلغ نهایی پیش‌فاکتور، مبلغ بسته‌بندی و ارسال اضافه می‌شود.<br>
...
در پیام‌گستر می‌توانید از روی فرصتی که برای هویت ثبت کرده‌اید به صورت مستقیم پیش‌فاکتور ثبت کنید. در این حالت این پیش‌فاکتور متصل با فرصت در سابقه هویت ثبت می‌شود. برای ثبت پیش‌فاکتور از روی فرصت می‌توانید از طریق مسیر‌های زیر اقدام نمایید:<br>
- **فرصت** > **فرصت جدید** > **محصولات فرصت** > **صدور پیش‌فاکتور** 

![مسیر اول ثبت پیش‌فاکتور از فرصت](./Images)

- **صفحه‌اصلی پروفایل مخاطب** > **سوابق** > **پیش‌فاکتور جدید**

![مسیر دوم ثبت پیش‌فاکتور از فرصت](./Images)

- **صفحه‌اصلی پروفایل مخاطب** > **مشخصات** > **آیتم جدید** > **پیش‌فاکتور جدید**

![مسیر سوم ثبت پیش‌فاکتور از فرصت](./Images)

> **نکته**<br>
> چنانجه از روش دوم و سوم برای ثبت پیش‌فاکتور از روی فرصت اقدام کنید، محصولاتی که در فرصت ثبت شده‌اند به صورت خودکار در پیش‌فاکتور متصل به فرصت ثبت نخواهند شد و نیاز است به صورت دستی محصولات را اضافه کنید در حالیکه در روش اول محصولات ثبت شده در فرصت به صورت خودکار در پیش‌فاکتور متصل به فرصت هم ثبت خواهند شد.<br>
...
- **صفحه‌اصلی پیش‌فاکتور**> **مشخصات** > **صدور پیش‌فاکتور**

![مسیر اول ثبت پیش‌فاکتور از پیش‌فاکتور](./Images)

- **صفحه‌اصلی پروفایل مخاطب** > **تب سوابق** > **پیش‌فاکتور جدید**

![مسیر دوم ثبت پیش‌فاکتور از پیش‌فاکتور](./Images)
