...
چنانچه محصولاتی که به مشتری فروخته شده به دلایل مختلف مانند معیوب بودن یا کیفیت پایین مرجوع شوند می‌بایست فاکتور برگشت از فروش ثبت کنید. از این طریق می‌توانید انواع محصولات خریداری شده یا خدمات ارائه شده، مبلغی که مشتری باید برای آن‌ها پرداخت کرده و همچنین لیست قیمت را مشاهده کنید. <br>

## مسیر‌های ثبت فاکتور برگشت‌از‌فروش
برای ثبت فاکتور برگشت‌از‌ فروش در پیام‌گستر، مسیرهای مختلفی وجود دارد. بنا بر نیاز خود می‌توانید از مسیرهای زیر اقدام به ثبت برگشت‌از‌فروش جدید برای مشتری خود نمایید.<br>

###  ثبت فاکتوربرگشتی از طریق تب فروش
**تب فروش** > **فاکتور فروش** > **زیرنوع فاکتور فروش** > **افزودن فاکتور برگشت‌از‌فروش**

![مسیر اول ثبت فاکتور برگشت‌از‌فروش از تب فروش](./Images/)
...
- **صفحه اصلی پروفایل مخاطب** > **تب فروش** > **برگشت‌ از‌ فروش**

![مسیر دوم ثبت فاکتور برگشت‌از‌فروش از صفحه مخاطب](./Images/)

- **صفحه اصلی پروفایل مخاطب** > **تب سوابق** > **صدور فاکتور برگشت‌ از‌ فروش جدید**

![مسیر سوم ثبت فاکتور برگشت‌از‌فروش از صفحه مخاطب](./Images/)

> **نکته**<br>
> توجه داشته باشید که چنانچه از صفحه هویت مورد نظر اقدام به ثبت فاکتور برگشتی نمایید، بخش «مرتبط با» به صورت خودکار با نام هویت پر می‌شود. به عبارت دیگر فاکتور به نام هویت ثبت می‌شود. اما اگر از مسیرهای صفحه اصلی (مسیر اول) اقدام به ثبت فاکتور برگشت از فروش نمایید، باید نام هویت را در قسمت «مرتبط با» جستجو و انتخاب کنید.<br>
...
برای ثبت فاکتور برگشت از فروش، لازم است فیلدهای مورد نیاز آیتم را با اطلاعات موجود تکمیل و سپس ذخیره نمایید. مشخصات فاکتورها در پیام‌گستر به شرح زیر می‌باشد:<br>
...
### ۲. مشخصات <br>
- **لیست قیمت:** با استفاده از این قسمت می‌توانید لیست قیمت مورد نظر خود را انتخاب نمایید، تا قیمت خدمات/کالاهای این فاکتور برگشتی بر اساس آن درج شود. با اتنخاب لیست قیمت در این قسمت، تمامی قیمت‌‌های درج شده در جدول مشخصات ردیف فاکتور برگشت از فروش بر اساس آن لحاظ می‌شود. <br>
...
- **شماره:** در صورتی که مجوز شماره‌گذاری این نوع فاکتور فروش برگشتی را داشته‌باشید، می‌توانید به صورت دستی این فاکتور برگشتی را شماره‌گذاری کنید. در غیر این صورت پس از ذخیره فاکتور برگشتی، کاربرانی که مجوز شماره‌گذاری داشته باشند آن را در کارتابل فاکتورهای فروش خود مشاهده خواهند نمود و می‌توانند آن را شماره‌گذاری کنند. در صورت نیاز، کاربر دارای مجوز شماره‌گذاری فاکتور برگشت از فروش، ویرایش شماره پس از شماره‌گذاری یا مدیر فروش می‌تواند این شماره را به دلخواه تغییر دهد.
...
چنانچه به دلایل مختلفی کالاهای فروخته شده مرجوع شوند می‌توانیداز روی فاکتورفروش به صورت مستقیم فاکتور برگشت از فروش صادر کنید و از طریق مسیرهای زیر اقدام نمایید:

- **صفحه‌اصلی پروفایل مخاطب**> **مشخصات** > **صدور فاکتور**

![مسیر اول ثبت فاکتور برگشتی از فاکتور](./Images)

- **صفحه‌اصلی پروفایل مخاطب** > **تب سوابق** > **فاکتور جدید**

![مسیر دوم ثبت فاکتور برگشتی از فاکتور](./Images)

- **صفحه‌اصلی پروفایل مخاطب** > **مشخصات** > **آیتم جدید** > **فاکتور جدید**

![مسیر سوم ثبت فاکتور برگشتی از فاکتور](./Images)
