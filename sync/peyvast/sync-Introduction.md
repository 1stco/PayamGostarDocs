### انتقال داده بین پیام‌گستر و پیوست

#### همگام‌ساز پیوست

ماژول همگام‌ساز پیوست و پیام‌گستر، یک نرم‌افزار تکمیلی تولید‌شده توسط پیام‌گستر می‌باشد که اطلاعات هویت‌ها، محصولات، پیش‌فاکتورهای فروش، فاکتورهای فروش، فاکتورهای برگشت از فروش، دریافت‌ها و پرداخت‌ها را از نرم‌افزار پیوست به پیام‌گستر و اطلاعات هویت‌ها و پیش‌فاکتورها را از نرم‌افزار پیام‌گستر به پیوست منتقل می‌کند. لازم بذکر است تمامی اطلاعات به محض ثبت در نرم‌افزار مالی به پیامگستر منتقل می‌شوند.
