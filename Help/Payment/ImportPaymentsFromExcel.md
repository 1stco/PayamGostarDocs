...
- [شیوه‌ی تهیه و تنظیم فایل اکسل دریافت‌ها](#PaymentExcelSetting)
- [روش بارگذاری فایل اکسل دریافت‌ها](#PaymentExcelUploading)
- [مجوزهای لازم برای بارگذاری اکسل دریافت‌ها](#PaymentExcelPermision)
...
![نمونه اکسل دریافت](./Images/payment-excel-sample.png)
...
![مسیر ورود اکسل دریافت](./Images/payment-excel-import.png)
...
![بارگذاری اکسل دریافت](./Images/payment-excel-upload.png)
...
![تنظیمات بارگذاری اکسل دریافت](./Images/payment-excel-setting.png)
...
![نگاشت فیلدها در اکسل دریافت](./Images/payment-excel-sync.png)
