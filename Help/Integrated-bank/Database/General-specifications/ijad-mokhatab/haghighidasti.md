...
پس از انتخاب شرکت، صفحه زیر باز شده و می‌توانید در این صفحه زیرنوع هویت مورد نظرتان را انتخاب کنید.ساخت و ویرایش زیرنوع هویت‌ها را می‌توانید ازطریق [شخصی سازی]( https://github.com/1stco/PayamGostarDocs/blob/master/Help/Settings/Personalization-crm/Overview/General-information/General-information.md) انجام دهید. 
...
**2.شرکت‌ها:** اگر هویت حقیقی عضو پرسنل شرکتی باشد، در این قسمت نام شرکت را نمایش می‌دهد.(برای مشخص کردن شرکت، بعد از ذخیره اطلاعات هویت حقیقی در نوار ابزار بالای صفحه، از قسمت پرسنل می‌توان شرکت مورد نظر را انتخاب کرد. برای آشنایی بیشتر با تب شرکت به [  تب شرکت‌ها]( https://github.com/1stco/PayamGostarDocs/blob/master/Help/Integrated-bank/Database/Personnel-Companies/Sherkathamd.md) مراجعه کنید)
