#  قابلیت راست کلیک روی دسته بندی هویت‌ها 
...
**4. ورود اطلاعات از طریق اکسل:** به قسمت [ورودی اکسل](https://github.com/1stco/PayamGostarDocs/blob/master/Help/Integrated-bank/Excel-input/import-excel-identity.md)  مراجعه کنید .
