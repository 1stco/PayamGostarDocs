...
برای مشاهده لیست همه پیش‌فاکتورهای فروش ثبت شده در سیستم، می‌توانید از دو مسیر اقدام نمایید:<br>

- از مسیر **تب فروش** > **پیش‌فاکتور فروش** > **زیرنوع پیش‌فاکتور فروش** با انتخاب یکی از زیرنوع‌های پیش‌فاکتور فروش، وارد صفحه پیش‌فاکتورها می‌شوید. در این حالت، تمامی پیش‌فاکتورهای فروش ثبت‌شده از زیرنوع انتخابی به شما نمایش داده‌می‌شود.<br>

![مسیر اول نمایش لیست پیش‌فاکتورهای فروش](./Images/quoate-list-method1-2.8.3.png)
...
- از مسیر **تب بانک یکپارچه** > **تاریخچه CRM**  می توانید با اعمال فیلتر «نوع» بر روی پیش‌فاکتور فروش و انتخاب زیرنوع مورد نظر/همه در فیلتر کناری، تمامی پیش‌فاکتورهای فروش ثبت شده را مشاهده نمایید.

![مسیر دوم نمایش لیست پیش‌فاکتورهای فروش](./Images/quoate-list-method1-2.8.3.png)
...
- از طریق **تب بانک یکپارچه** > **تاریخچه CRM** با اعمال فیلتر(کادر قرمز بالا)،  پیش‌فاکتورها را یافته  و با استفاده از جستجوی «پروفایل مرتبط» (کادر قرمز پایین) پیش‌فاکتورهای فروش هویت مورد نظر را جدا کنید. بدین منظور کافیست نام هویت را در قسمت مربوطه نوشته و Enter کنید.<br>
