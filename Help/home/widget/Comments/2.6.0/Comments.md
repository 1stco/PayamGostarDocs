...
> **نکته**<br>
> اگر در ارسال پیام خود از طریق **ویجت نظرات** موجود در داشبورد، از کاربری نام نبرده باشید (کاربری را منشن نکرده باشید)، پیام برای تمامی کاربران ارسال می‌شود و اگر گزینه‌ی «فقط نام‌برده شده از من» در ویجت نظرات کاربر غیرفعال باشد، پیام شما را در ویجتش مشاهده می‌کند.<br>
