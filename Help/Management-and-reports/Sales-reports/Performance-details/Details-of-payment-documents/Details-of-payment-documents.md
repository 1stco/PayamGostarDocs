...
> **نکته:** توجه داشته باشید، این گزارش مربوط به اسناد پرداخت نشده می باشد و در صورتی که چک باکس "پرداخت شده" در یک پرداخت، فعال شده باشد، گزارش مربوط به آن بر اساس تاریخ پرداخت در گزارش[ جزئیات پرداخت ها](https://github.com/1stco/PayamGostarDocs/blob/master/Help/Management-and-reports/Sales-reports/Performance-details/Payment%20details/Payment-details.md) قابل مشاهده است
