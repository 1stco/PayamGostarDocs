...
برای آغاز به کار با گزارش‌ساز باید قبل از هر اقدامی مجموعه داده‌ای (Data Set) که قصد دریافت گزارش از آن را دارید مشخص کنید.              

> **نکته:** <br> برای دریافت این گزارش کاربر باید مجوز مشاهده گزارش‌های ساخته‌شده را داشته باشد. 

## ایجاد گزارش جدید
ایجاد گزارش جدید در سه مرحله دریافت اطلاعات پایه، افزودن منبع اطلاعاتی جدید و طراحی گزارش انجام می‌شود. در ادامه جزئیات هر مرحله شرح داده می‌شود. 
### مرحله اول: دریافت اطلاعات پایه 
دریافت اطلاعات پایه از دو مسیر آیتم‌ها و منوی گزارش‌‌ها می‌تواند انجام شود که در ادامه بررسی می‌شوند. 

#### 1. دریافت اطلاعات پایه از مسیر آیتم‌ها
...
#### 2. دریافت اطلاعات پایه با استفاده از مسیر منوی گزارش‌ها 
...
### مرحله دوم: افزودن منبع اطلاعاتی جدید
...
در این مرحله می‌توانید منبع موردنظر خود را برای تهیه گزارش از بین گزینه‌های ارائه‌شده انتخاب کنید.
...
![](./Images/Create-Report-of-CRM-Items-List.jpg)

با کلیک بر روی ایجاد گزارش مراحل ایجاد گزارش آغاز می‌شود.


![](./Images/reportnew2.png)
...
**B. افزودن منابع:** در صورت دارابودن ماژول گزارش‌ساز پیشرفته با استفاده از این کلید، این امکان به کاربر داده شده است که از منابع مختلفی برای تهیه گزارش موردنظر استفاده کرد که پیش‌تر در رابطه‌با این موارد توضیح داده خواهد شد.
...
![](./Images/reportnew3.jpg)

**1.بانک اطلاعاتی پیام‌گستر:** از منابع پیام‌گستر زمانی استفاده می‌شود که بخواهیم علاوه بر موجودیتی که در حال گزارش‌گیری آن هستیم از موجودیت‌های دیگری در این گزارش استفاده کنیم.
...
**مثال:** فیلد‌های IdentityId و IdentityIdPreview درمورد هویت‌ها، در ادامه از فیلد  IdentityPreview زمانی استفاده می‌کنیم که بخواهیم نام هویت مرتبط با آیتم جاری را نمایش دهیم. 


لازم به ذکر است، زمانی فیلد Identityمورداستفاده قرار می‌گیرد که قصد ایجاد ارتباط بین هویت‌ها و سایر آیتم‌ها را داشته باشیم. به‌این‌ترتیب این فیلد تحت عنوان یک کلید مورداستفاده است.

در ادامه چگونگی برقراری این ارتباط را در استفاده از بخش Expression توضیح داده خواهد شد.

**مثال:** فرض کنید قصد داریم رنگ هویت‌های مرتبط با لیست موجودیت انتخاب شده را در گزارش به‌عنوان خروجی دریافت کنیم.
