...
- [ویرایش محصولات از طریق اکسل](#UpdatingProductsViaExcel)

> **نکته**<br>
> ابتدا راهنمای «[افزودن محصول](https://tfs.1st.co.com/tfs/AbrPlus/Tech-AbrPlus-Documentation/_git/Tech-AbrPlus-Documentation-PG2?path=/Help/Basic-Information/Product-management/AddingProduct_2.8.6.md&_a=preview)» را مطالعه نمایید تا با فیلدهای اطلاعاتی محصولات و خدمات در پیام‌گستر آشنایی داشته باشید.<br>
...
![اکسل نمونه محصولات](./Images/products-excel-sample-2.8.6.png)
...
علاوه بر فیلدهای فوق، شما می‌توانید ویژگی‌های محصولات/خدمات را نیز از طریق اکسل وارد نمایید. نام ویژگی‌های مورد نظر را به ستون‌های اکسل خود اضافه کنید و سپس مقدار آن را برای هر محصول وارد نمایید. توجه داشته باشید که اگر مقدار یک ویژگی در ردیف یک محصول خالی باشد، آن ویژگی برای محصول مورد نظر درج نمی‌شود. 

![ویژگی محصول در اکسل](./Images/products-specifications-in-excel-2.8.6.png)

## مراحل بارگذاری فایل اکسل{#ProductsExcelUpload}
بارگذاری اکسل محصولات در پیام‌گستر، دو گام اصلی دارد:<br>
### گام اول: انتخاب فایل اکسل
...
![بارگذاری فایل اکسل نمونه محصولات](./Images/products-excel-setting-2.8.6.png)
...
![نگاشت محصولات](./Images/products-excel-sync-2.8.6.png)
...
**2. اضافه کردن:** پس از انجام نگاشت دستی، می‌توانید این نگاشت (ترتیبی که عناوین اکسل شما با عناوین نرم‌افزار در کنار یکدیگر قرار‌گرفته‌اند) را در سیستم ذخیره کنید تا در بارگذاری‌های بعدی از آن‌ استفاده کنید.<br>
**3. انتخاب نگاشت:** اگر قبلاً نگاشتی را ذخیره کرده‌باشید، از این لیست می‌توانید آن را انتخاب کنید.<br>
...
**4. ستون‌های اکسل:** ستون‌های اکسل در سمت راست و فیلدهای محصول در سمت چپ به شما نمایش داده‌می‌شود. عناوینی که نگاشت آن‌ها به صورت خودکار انجام نشده‌است را به صورت دستی نگاشت کنید. کافیست که هر عنوان را از ستون سمت راست انتخاب کرده، کشیده و در ستون سمت چپ، کنار فیلد متناظر آن رها کنید. <br>

>**نکته**<br>
> چنانچه برای یک یا چند ردیف از محصولات، ویژگی تعریف کرده باشید، نام‌ آن‌ها را در ستون سمت راست مشاهده می‌کنید. این عناوین را با مشخصه‌هایی که در ستون سمت چپ مشاهده می‌کنید، نگاشت کنید. ترتیب اتصال نام ویژگی‌ها به مشخصه‌ها، تنها در ترتیب قرار گرفتن آن‌ها در جدول مشخصات تاثیر دارد. پس بدون نیاز به رعایت ترتیب خاصی، هر یک از ویژگی‌ها را به یکی از مشخصه‌ها متصل کنید.  

**5. ورود اطلاعات:** با انتخاب این کلید محصولات فایل اکسل وارد نرم‌افزار خواهدشد.<br>

## ویرایش محصولات از طریق اکسل{#UpdatingProductsViaExcel}
با استفاده از اکسل می‌توانید محصولات و خدماتی که پیش‌تر در سیستم تعریف کرده‌اید را ویرایش کنید. <br>

>**نکته**<br>
> جهت ویرایش اطلاعات محصولات و خدمات از طریق اکسل، لازم است که محصول/خدمت دارای **کد** باشد.  محصولات و خدماتی که برای آن‌ها کد تعریف نکرده‌اید را نمی‌توانید از طریق اکسل ویرایش کنید. <br>

جهت ویرایش محصولات از طریق اکسل، مراحل زیر را طی کنید:<br>
- وارد دسته‌بندی مورد نظر (که قصد ویرایش محصولات/خدمات آن را دارید) شوید.
- محصولات را انتخاب کرده و از آن خروجی اکسل تهیه کنید. 
- مشخصات مورد نظر را ویرایش نمایید. اگر قصد افزودن هر نوع اطلاعات را دارید آن را در ستون‌های مورد نظر درج کنید. در صورت نیاز به افزودن ویژگی، می‌توانید ستون‌های ویژگی‌های مورد نظر را نیز به اکسل خود اضافه کنید.
- سپس به شیوه‌ای که در بخش «مراحل بارگذاری فایل اکسل» گفته شد، فایل اکسل خود را بارگذاری کنید. توجه داشته باشید که جهت ویرایش اطلاعات، گزینه‌ی «به‌روزرسانی در صورت تکراری بودن کد محصول» را به عنوان روش بارگذاری انتخاب کنید.

>**نکته**<br>
> برای ثبت محصولات از طریق اکسل کاربر باید مجوز «مدیریت  محصولات» را داشته‌باشد تا بتواند محصولات و خدمات را بارگذاری کند.<br>