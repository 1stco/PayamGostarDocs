# فاکتور خرید جدید 
شما از طریق مسیرهای زیر میتوانید یک فاکتور خرید جدید ثبت کنید.<br>
...
- **صفحه اصلی پروفایل مشتری** > **مشخصات** > **فاکتور جدید**

![مسیر سوم ثبت فاکتور](./Images/new-invoice-method3.png)

- **صفحه اصلی پروفایل مشتری** > **سوابق** > **فاکتور جدید**

![مسیر چهارم ثبت فاکتور](./Images/new-invoice-method4.png)

- **صفحه اصلی پروفایل مشتری** > **خرید** > **فاکتور**
...
> **نکته** <br>
تنها شخص دارنده مجوز "ویرایش پس از شماره گذاری، تایید یا رد"  می‌تواند محتوای یک فاکتور  تایید شده را تغییر دهد و سایر اشخاص دسترسی تغییر محتوای فاکتور  تایید شده را نخواهند داشت.
>> **نکته** <br>
...
>> **نکته**<br> در صورت نیاز می‌توانید مبلغی را به عنوان اضافات به فاکتور اضافه نمایید، این مبلغ در انتهای فاکتور و در کنار مجموع تخفیف و مالیات نمایش داده خواهد شد (برای مثال به قیمت نهایی فاکتور و یا پیش فاکتور یک مبلغ به عنوان هزینه باربری اضافه گردد.)
