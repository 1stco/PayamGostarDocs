...
## مسیر‌های ثبت دریافت
برای ثبت دریافت جدید به صورت دستی (توسط کاربر) از یکی از مسیرهای زیر اقدام نمایید:<br>

- ویجت دسترسی سریع > دریافت
- تب فروش در منوی اصلی > دریافت > زیرنوع دریافت > افزودن دریافت
- صفحه پروفایل مخاطب > آیتم جدید (فلش کنار تماس جدید) > دریافت جدید
- صفحه پروفایل مخاطب > تب سوابق > دریافت جدید
- صفحه پروفایل مخاطب > تب دریافت/پرداخت > دریافت جدید
- صفحه انواع آیتم‌ها (می‌تواند صفحه فاکتور یا هر آیتم دیگری باشد) > آیتم جدید (فلش کنار تماس جدید) > دریافت جدید

> **نکته**<br>
> توجه داشته باشید که چنانچه از صفحه هویت مورد نظر یا آیتمی مرتبط با او اقدام به ثبت دریافت نمایید (مسیر سوم، چهارم،پنجم و ششم)، بخش «مرتبط با» به صورت خودکار با نام هویت پر می‌شود. به عبارت دیگر دریافت به نام هویت ثبت می‌شود. اما اگر از مسیرهای صفحه اصلی (مسیر اول و دوم) اقدام به ثبت دریافت نمایید، باید نام هویت را در قسمت «مرتبط با» جستجو و انتخاب کنید.<br>
...
### فیلدهای دریافت نقدی
- **روش دریافت نقدی:** در این فیلد می‌توانید روش دریافت وجه را از بین گزینه‌های کارت به کارت، واریز به حساب بانکی، پرداخت آنلاین، پرد
اخت حضوری، لینک پیام‌گستر پرداخت و دستگاه کارتخوان انتخاب کنید. توجه داشته باشید که روش‌های آنلاین، لینک و کارتخوان بیشتر برای ثبت دریافت‌های خودکار سیستم کاربرد و دارد و اغلب به صورت دستی انتخاب نمی‌شوند.
- **کد شعبه:** در صورت انتخاب روش «واریز به حساب بانکی» کد شعبه‌ای که واریز در آن انجام شده‌است را در این قسمت درج کنید.
- **شماره ترمینال:** در صورت انتخاب روش «دستگاه کارتخوان» دستگاهی که پرداخت از طریق آن انجام شده در این فیلد مشخص می‌شود.
- **شماره کارت/رسید:** شماره رسید واریزی و یا شماره کارتی که واریز به آن انجام گرفته‌است را در این قسمت درج نمایید.
- **شماره پیگیری:** در شرایط واریز مبلغ از طرف مشتری می‌توانید شماره پیگیری مندرج در فیش واریز را در این قسمت ثبت نمایید.

> **نکته**<br>
> پس از انتخاب روش دریافت نقدی، فیلدهای مرتبط به روش منتخب شما نمایش داده می‌شود.
...
> **نکته**<br>
> کسر مبلغ از مانده حساب مشتری منوط به فعال‌سازی گزینه‌ی «دریافت شده» نمی‌باشد. آیتم دریافت پس از ثبت و تایید، تاثیر خود را بر روی مانده حساب مشتری می‌گذارد. این گزینه صرفاً جهت امکان جداسازی مطالبات وصول شده و در انتظار تسویه می‌باشد.<br>
