...
> **نکته**<br>
> در صورت افزودن کارتابل به صورت دستی در ویرایش گردش کاری فرآیند، قابلیت انقضای کارتابل فاقد عملکرد می‌باشد. به عبارت دیگر، انقضای کارتابل صرفاً در حالتی که فرآیند طی روند طراحی شده‌اش به کارتابل برسد، اعمال خواهد بود. 
