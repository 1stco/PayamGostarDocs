...
> **نکته**<br>
با توجه به اینکه Expression در حال حاضر بر روی موجودیت‌های رسید و حواله قابل استفاده نمی‌باشد، برای مقداردهی فیلدهای همین موجودیت استفاده کنید، صرفاً می‌توانید از دستورات SQL استفاده کنید. 
