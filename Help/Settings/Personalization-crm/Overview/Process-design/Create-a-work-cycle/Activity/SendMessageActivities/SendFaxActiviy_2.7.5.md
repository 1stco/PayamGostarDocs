...
- [فعالیت ارسال فکس  و کاربرد آن](#SendFaxActivityPurpose)
- [تنظیمات فعالیت ارسال فکس در فرآیند](#SendFaxActivitySettings)

## فعالیت ارسال فکس چیست و چه کاربردی دارد؟{#SendFaxActivityPurpose}
...
## تنظیمات فعالیت ارسال فکس{#SendFaxActivitySettings}
