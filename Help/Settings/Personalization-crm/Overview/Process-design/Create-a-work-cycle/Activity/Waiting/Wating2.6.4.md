...
**3. در صورت بروز رویداد:** در صورت انتخاب این گزینه،می توانید شرط شکستن این انتظار را فراخوانی رویداد در یک فرآیند دیگر تعیین کنید. برای اطلاعات بیشتر فعالیت[ فرخوانی رویداد ](https://github.com/1stco/PayamGostarDocs/blob/master/Help/Settings/Personalization-crm/Overview/Process-design/Create-a-work-cycle/Activity/Call-the-event/Call-the-event.md)را مطالعه فرمایید.
...
> **نکته**<br>
> در صورت برقراری شرط ممکن است که حداکثر تا یک ساعت برای عملکرد این شرط زمان نیاز باشد.<br>
...
> **نکته**<br>
> توجه داشته باشید که در صورت رسیدن به فعالیت انتظار، اعمال هر گونه ویرایش بر روی فیلدی که شرط اتمام انتظار بر اساس آن تنظیم شده‌است، بر روی زمان اتمام آن تاثیری نمی‌گذارد. انتظار بر اساس شرطی که هنگام ورود فرایند به فعالیت در آن تنظیم بوده اجرا می‌شود. به عنوان مثال اگر مدت زمان انتظار بر اساس فیلد «روز» باشد، چنانچه هنگام ورود فرایند به فعالیت انتظار، عدد ۵ در فیلد درج شده باشد لکن کاربر با ویرایش آیتم آن را به ۷ تغییر دهد، زمان انتظار کماکان ۵ روز در نظر گرفته می‌شود. 