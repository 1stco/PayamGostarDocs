...
در این قسمت لیست رسید هایی که همه یا تعدادی از اقلام موجود در آن ها از طریق [قیمت گذاری](../../../Buysaleswarehouse/Warehouses/Pricing.md) به هیچ فاکتور خرید یا حواله مرجوعی وصل نشده است را می توانید مشاهده کنید.
...
 ![](EnterInventoryTransaction/EnterInventoryTransaction.png)
...
![](EnterInventoryTransaction/EnterInventoryTransaction2.png)