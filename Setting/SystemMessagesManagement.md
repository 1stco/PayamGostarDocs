...
![](SystemMessagesManagement/SystemMessagesManagement1.png) 

با کلیک بر روی لینک ویرایش پیام ها در روبروی هر پیام، پنجره ای به شکل زیر باز خواهد شد.

![](SystemMessagesManagement/SystemMessagesManagement2.png) 
...
برای اطلاعات بیشتر در خصوص نحوه تنظیم پیام به [اطلاعات مشترک ابزارها](../AdvertisedTools/ToolsSharedInformation.md) و برای اطلاع از چگونگی عملکرد پارامترهای هوشمند به [متن هوشمند](../AdvertisedTools/InteligentContext.md) مراجعه کنید.

![](SystemMessagesManagement/SystemMessagesManagement3.JPG)

![](SystemMessagesManagement/SystemMessagesManagement4.JPG)
